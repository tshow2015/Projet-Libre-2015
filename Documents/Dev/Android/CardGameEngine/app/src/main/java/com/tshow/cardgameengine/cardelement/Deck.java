...
public class Deck {
    ...
    public Deck(boolean includeJokers) {
        ...
        if (includeJokers) {
            deck.add(52, new Card(Card.JOKER, 0));
            deck.add(53, new Card(Card.JOKER, 1));
        }
        cardsUsed = 0;
     ...
     */
    //loookupa shuffle function in java
    public void shuffle() {
    ...
    public Card dealCard() {
        ...
        cardsUsed++;
        //usedDeck.add(deck.remove(0));
        //return usedDeck.get(usedDeck.size()-1);
        return deck.remove(0);
    }
    public void addUsedCard(Card usedCard) {
        usedDeck.add(usedCard);
    }
    ...
    public ArrayList<Card> getUsedDeck() {return usedDeck;}
} // end class Deck